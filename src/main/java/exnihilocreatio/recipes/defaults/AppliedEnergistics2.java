...
public class AppliedEnergistics2 implements IRecipeDefaults {
    ...
    public void registerSieve(SieveRegistry registry) {
        // Sky Stone Dust
        registry.register(ModBlocks.dust, 0, new ItemInfo(AE_MATERIAL, 45), 0.1f, MeshType.FLINT.getID());
        registry.register(ModBlocks.dust, 0, new ItemInfo(AE_MATERIAL, 45), 0.2f, MeshType.IRON.getID());
        registry.register(ModBlocks.dust, 0, new ItemInfo(AE_MATERIAL, 45), 0.3f, MeshType.DIAMOND.getID());

        // Certus Quartz
        ItemInfo stack = new ItemInfo(AE_MATERIAL, 0);
        registry.register(ModBlocks.skystoneCrushed, 0, stack, 0.01f, MeshType.IRON.getID());
        registry.register(ModBlocks.skystoneCrushed, 0, stack, 0.02f, MeshType.DIAMOND.getID());

        // Pure Certus Quartz Seed
        stack = new ItemInfo(AE_SEEDS, 0);
        registry.register(ModBlocks.skystoneCrushed, 0, stack, 0.01f, MeshType.STRING.getID());
        registry.register(ModBlocks.skystoneCrushed, 0, stack, 0.01f, MeshType.FLINT.getID());
        registry.register(ModBlocks.skystoneCrushed, 0, stack, 0.02f, MeshType.IRON.getID());
        registry.register(ModBlocks.skystoneCrushed, 0, stack, 0.02f, MeshType.DIAMOND.getID());

        // Charged Certus Quartz
        stack = new ItemInfo(AE_MATERIAL, 1);
        registry.register(ModBlocks.skystoneCrushed, 0, stack, 0.001f, MeshType.DIAMOND.getID());
    }
