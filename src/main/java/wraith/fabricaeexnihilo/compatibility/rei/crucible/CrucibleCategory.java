...
public record CrucibleCategory(CategoryIdentifier<? extends CrucibleDisplay> crucible, ItemStack icon, Text name) implements DisplayCategory<CrucibleDisplay> {
